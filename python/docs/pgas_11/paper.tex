...
% program. For example, when accessing the global array as an \verb=ndarray=, the array
...
% \verb=gain.ndarray= and array operations
% =====================================
...
% .. table:: \verb=laplace.py= for N=10,000. One matrix of double-precision
...
%     +-------+-----------------+---------------+
% 
% .. table:: \verb=laplace.py= for N=100,000. One matrix of double-precision
...
%\multicolumn{2}{|c|}{Depth-1 Cache} &
%\multicolumn{2}{|c|}{Depth-2 Cache} &
%\multicolumn{2}{|c|}{Depth-3 Cache} \\
%\hline
