...
void summa_ab( m, n, k, nb, alpha, a, lda, b, ldb, 
...
void RING_Bcast( buf, count, root, me, me_to, me_from, msg_id )
...

{
  ...
  if( me != root ) {
    ...
    RCV_( &msg_id, (char *) buf, &isize, &lenmes, &me_from, &nodefrom, &isync );
  }
