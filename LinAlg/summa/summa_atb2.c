/*
 * Same as summa_atb, but local block of B is assumed to be stored
 * in transposed form.
 */
#include <stdio.h>
#include "global.h"
...
void summa_atb2( m, n, k, nb, alpha, a, lda, b, ldb, 
 ...
 */
{
  ...
  for ( kk=0; kk<m; kk+=iwrk) {
    ...
    /* update local block                              */
    dgemm_( "Transpose", "Transpose", &iwrk, &n_c[ mycol ], &m_a[ myrow ],
