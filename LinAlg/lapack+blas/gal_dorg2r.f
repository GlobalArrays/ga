...
*
*  =====================================================================
      SUBROUTINE GAL_DORG2R(M,N,K,A,LDA,TAU,WORK,INFO)
*
...
*
      ...
      END IF
      IF(INFO.NE.0)THEN
      CALL GAL_XERBLA('GAL_DORG2R',-INFO)
      RETURN
      END IF
*
...
*
      IF(I.LT.N)THEN
      A(I,I)=ONE
      CALL GAL_DLARF('LEFT',M-I+1,N-I,A(I,I),1,TAU(I),
     $A(I,I+1),LDA,WORK)
      END IF
      IF(I.LT.M)
     $CALL GAL_DSCAL(M-I,-TAU(I),A(I+1,I),1)
      A(I,I)=ONE-TAU(I)
*
