...
*>
*  =====================================================================
      SUBROUTINE GAL_DTRSM(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,LDB)
*
...
*     .. Scalar Arguments ..
      DOUBLE PRECISION ALPHA
      INTEGER LDA,LDB,M,N
      CHARACTERDIAG,SIDE,TRANSA,UPLO
*     ..
*     .. Array Arguments ..
      DOUBLE PRECISION A(LDA,*),B(LDB,*)
*     ..
...
*
      INFO=0
      IF((.NOT.LSIDE).AND.(.NOT.GAL_LSAME(SIDE,'R')))THEN
      INFO=1
