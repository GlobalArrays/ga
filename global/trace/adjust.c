/*$Id: adjust.c,v 1.7 1999-11-09 19:49:05 d3h325 Exp $*/
/***********************************************************************\
...
char *foutname = "adjust.ed", finname[8];
   ...
   if(argc<3){
      printf("Usage: adjust <number of processes> <array handle> [<max number of events>] \n");
      exit(1);
   } 
