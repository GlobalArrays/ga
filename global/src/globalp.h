...
EXT void  pnga_error(char *string, INT icode);
...
EXT LOG   pnga_create_config(INT type, INT ndim, INT dims[], char* array_name, INT chunk[], INT p_handle, INT *g_a);
EXT LOG   pnga_create_ghosts_config(INT type, INT ndim, INT dims[], INT width[], char* array_name, INT chunk[], INT p_handle, INT *g_a);
EXT LOG   pnga_create_ghosts(INT type, INT ndim, INT dims[], INT width[], char* array_name, INT chunk[], INT *g_a);
EXT LOG   pnga_create_ghosts_irreg_config(INT type, INT ndim, INT dims[], INT width[], char *array_name, INT map[], INT nblock[], INT p_handle, INT *g_a);
EXT LOG   pnga_create_ghosts_irreg(INT type, INT ndim, INT dims[], INT width[], char *array_name, INT map[], INT nblock[], INT *g_a);
EXT LOG   pnga_create(INT type, INT ndim, INT dims[], char* array_name, INT *chunk, INT *g_a);
EXT LOG   pnga_create_irreg_config(INT type, INT ndim, INT dims[], char *array_name, INT map[], INT nblock[], INT p_handle, INT *g_a);
EXT LOG   pnga_create_irreg(INT type, INT ndim, INT dims[], char *array_name, INT map[], INT nblock[], INT *g_a);
