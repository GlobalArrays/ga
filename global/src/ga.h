...
extern void          GA_Device_host_list(int *list, int *devIDs, int *ndev, int group);
...
extern int           GA_Pgroup_num_dev(int grp_id);
...
extern void          GA_Set_device(int g_a, int flag);
...
extern void          NGA_Add(void *alpha, int g_a, void* beta, int g_b, int g_c); 
...
extern void          NGA_Copy(int g_a, int g_b); 
...
extern void          NGA_Device_host_list(int *list, int *devIDs, int *ndev, int group);
...
extern int           NGA_Pgroup_num_dev(int grp_id);
...
extern void          NGA_Set_device(int g_a, int flag);
