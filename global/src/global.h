...
EXT void FATR ga_list_nodeid_(INT *list, INT *nprocs);
...
EXT void FATR ga_nblock(INT *g_a, INT *nblock);
...
EXT INT  FATR ga_pgroup_split_irreg_(INT *grp, INT *mycolor);
...
EXT void FATR ga_scatter_acc_(INT *g_a, void* v, INT *i, INT *j, INT *nv, void *alpha);
...
EXT LOG  FATR nga_allocate_(INT *g_a);
EXT LOG  FATR nga_compare_distr_(INT*, INT* );
EXT LOG  FATR nga_create_mutexes_(INT*);
EXT INT  FATR nga_create_handle_();
EXT LOG  FATR nga_destroy_(INT* );
EXT LOG  FATR nga_destroy_mutexes_(void);
EXT void FATR nga_distribution_(INT *g_a, INT *proc, INT *lo, INT *hi);
EXT LOG  FATR nga_duplicate_(INT*, INT*, char*, int);
EXT void FATR nga_fence_( void);
EXT void FATR nga_fill_(INT *, void *);
...
EXT void FATR nga_get_block_info_( INT *g_a, INT *num_blocks, INT *block_dims );
EXT LOG  FATR nga_get_debug_();
EXT INT  FATR nga_get_dimension_(INT *g_a);
EXT void FATR nga_get_ghost_block_(INT *g_a, INT *lo, INT *hi, void *buf, INT *ld);
EXT INT  FATR nga_get_pgroup_(INT *g_a);
EXT INT  FATR nga_get_pgroup_size_(INT *grp_id);
EXT void FATR nga_get_proc_grid_(INT* g_a, INT* dims);
EXT LOG  FATR nga_has_ghosts_(INT *g_a);
EXT void FATR nga_init_fence_( void);
EXT void FATR nga_initialize_( void);
EXT void FATR nga_initialize_ltd_( INT* );
EXT void FATR nga_inquire_(INT *g_a, INT *type, INT *ndim, INT *dims); 
EXT INT  FATR nga_inquire_memory_(void);
EXT void FATR nga_inquire_name_(INT*, char*, int);
EXT LOG  FATR nga_is_mirrored_(INT *g_a);
EXT void FATR nga_list_nodeid_(INT *list, INT *nprocs);
...
EXT void FATR nga_lock_(INT* );
EXT void FATR nga_mask_sync_(INT *begin, INT *end);
EXT INT  FATR nga_memory_avail_(void);
EXT LOG  FATR nga_memory_limited_( void);
EXT void FATR nga_merge_distr_patch_(INT *g_a, INT *alo, INT *ahi, INT *g_b, INT *blo, INT *bhi);
EXT void FATR nga_merge_mirrored_(INT *g_a);
EXT void FATR nga_nblock(INT* g_a, INT* nblock);
...
EXT INT  FATR nga_ndim_(INT *g_a);
EXT INT  FATR nga_nnodes_(void);
EXT INT  FATR nga_nodeid_(void);
...
EXT INT  FATR nga_pgroup_absolute_id_(INT *grp, INT *pid);
EXT INT  FATR nga_pgroup_create_(INT *list, INT *count);
EXT INT  FATR nga_pgroup_destroy_(INT *grp);
EXT INT  FATR nga_pgroup_get_default_();
EXT INT  FATR nga_pgroup_get_mirror_();
EXT INT  FATR nga_pgroup_get_world_();
EXT INT  FATR nga_pgroup_nnodes_(INT *grp_id);
EXT INT  FATR nga_pgroup_nodeid_(INT *grp_id);
...
EXT void FATR nga_randomize_(INT*, void*);
...
EXT void FATR nga_set_array_name_(INT *g_a, char *array_name, int slen);
EXT void FATR nga_set_block_cyclic_(INT *g_a, INT *dims);
EXT void FATR nga_set_block_cyclic_proc_grid_(INT *g_a, INT block[], INT proc_grid[]);
EXT void FATR nga_set_chunk_(INT *g_a, INT *chunk);
EXT void FATR nga_set_data_(INT *g_a, INT *ndim, INT *dims, INT *type);
EXT void FATR nga_set_debug_( LOG *flag );
EXT void FATR nga_set_ghosts_(INT *g_a, INT *width);
EXT void FATR nga_set_irreg_distr_(INT *g_a, INT *map, INT *nblock);
