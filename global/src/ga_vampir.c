...
void ga_vampir_init() {
    vampir_symdef(GA_ACC,                    "GA_Acc",                     "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ACCESS,                 "GA_Access",                  "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ADD,                    "GA_Add",                     "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ADD_PATCH,              "GA_Add_patch",               "GA",__FILE__,__LINE__);
    vampir_symdef(GA_BRDCST,                 "GA_Brdcst",                  "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_DDOT,                   "GA_Ddot",                    "GA",__FILE__,__LINE__);
    vampir_symdef(GA_DDOT_PATCH,             "GA_Ddot_patch",              "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_DGOP,                   "GA_Dgop",                    "GA",__FILE__,__LINE__);
    vampir_symdef(GA_DISTRIBUTION,           "GA_Distribution",            "GA",__FILE__,__LINE__);
    vampir_symdef(GA_DOT,                    "GA_Dot",                     "GA",__FILE__,__LINE__);
    vampir_symdef(GA_DOT_PATCH,              "GA_Dot_patch",               "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_GATHER,                 "GA_Gather",                  "GA",__FILE__,__LINE__);
    vampir_symdef(GA_GET,                    "GA_Get",                     "GA",__FILE__,__LINE__);
    vampir_symdef(GA_IGOP,                   "GA_Igop",                    "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_MATMUL_PATCH,           "GA_Matmul_patch",            "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_PERIODIC_ACC,           "GA_Periodic_acc",            "GA",__FILE__,__LINE__);
    vampir_symdef(GA_PERIODIC_GET,           "GA_Periodic_get",            "GA",__FILE__,__LINE__);
    vampir_symdef(GA_PERIODIC_PUT,           "GA_Periodic_put",            "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_PUT,                    "GA_Put",                     "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_SCALE,                  "GA_Scale",                   "GA",__FILE__,__LINE__);
    vampir_symdef(GA_SCALE_PATCH,            "GA_Scale_patch",             "GA",__FILE__,__LINE__);
    vampir_symdef(GA_SCATTER,                "GA_Scatter",                 "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(GA_SYNC,                   "GA_Sync",                    "GA",__FILE__,__LINE__);
    vampir_symdef(GA_TERMINATE,              "GA_Terminate",               "GA",__FILE__,__LINE__);
    vampir_symdef(GA_TRANSPOSE,              "GA_Transpose",               "GA",__FILE__,__LINE__);
    vampir_symdef(GA_UNLOCK,                 "GA_Unlock",                  "GA",__FILE__,__LINE__);
    vampir_symdef(GA_USES_MA,                "GA_Uses_ma",                 "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ZDOT,                   "GA_Zdot",                    "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ZDOT_PATCH,             "GA_Zdot_patch",              "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ZERO,                   "GA_Zero",                    "GA",__FILE__,__LINE__);
    vampir_symdef(GA_ZERO_PATCH,             "GA_Zero_patch",              "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_ACC,                   "NGA_Acc",                    "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_ACCESS,                "NGA_Access",                 "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_ADD_PATCH,             "NGA_Add_patch",              "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(NGA_GATHER,                "NGA_Gather",                 "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_GET,                   "NGA_Get",                    "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(NGA_PERIODIC_ACC,          "NGA_Periodic_acc",           "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_PERIODIC_GET,          "NGA_Periodic_get",           "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_PERIODIC_PUT,          "NGA_Periodic_put",           "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_PUT,                   "NGA_Put",                    "GA",__FILE__,__LINE__);
    ...
    vampir_symdef(NGA_SCALE_PATCH,           "NGA_Scale_patch",            "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_SCATTER,               "NGA_Scatter",                "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_SELECT_ELEM,           "NGA_Select_elem",            "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_ZDOT_PATCH,            "NGA_Zdot_patch",             "GA",__FILE__,__LINE__);
    vampir_symdef(NGA_ZERO_PATCH,            "NGA_Zero_patch",             "GA",__FILE__,__LINE__);
