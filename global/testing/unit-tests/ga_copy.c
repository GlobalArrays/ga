/*
 * Test Program for GA
 * This is to test GA_Duplicate and GA_Copy 
...
main(int argc, char **argv)
{
  ...
  int dims[DIM]={SIZE,SIZE}, dims2[DIM], ndim2, type2, dims3[DIM], ndim3, type3;
  int lo[DIM]={SIZE-SIZE, SIZE-SIZE}, hi[DIM]={SIZE-1,SIZE-1};
  int value=5, ld=5;
