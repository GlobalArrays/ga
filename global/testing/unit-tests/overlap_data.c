/*
  This program to automate lo_ and hi_ size; each process copies local array(of its own size) to corresponding global array memory space. 
 */
#include<stdio.h>
#include<stdlib.h>
#include<math.h>
...
int main(int argc, char **argv)
{
  ...
  if(rank==0) {
    for(i=0; i<nprocs; i++) {
      ...
      NGA_Put(g_A, lo1, hi1, local_A, &ld);
    }
  }
