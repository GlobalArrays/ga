...
for vendor in intel ibm pathscale amd gnu sun hp dec borland comeau cray kai lcc metrowerks sgi microsoft watcom portland fujitsu
do
AS_CASE([$vendor],
...
[cray],      [ga_cpp_vendor_symbols="defined(_CRAYC)"],
