...
[LINUX64:ibm:powerpc64],    [ga_cv_c_opt="-qlanglvl=extended -qinline=100 -qstrict -qarch=auto -qtune=auto"],
[LINUX64:ibm:ppc64],        [ga_cv_c_opt="-qlanglvl=extended -qinline=100 -qstrict -qarch=auto -qtune=auto"],
...
[LINUX:ibm:*],              [ga_cv_c_opt="-q32 -qlanglvl=extended"],
[LINUX:intel:*],            [ga_cv_c_opt="-O3 -prefetch"],
[MACX64:*:*],               [ga_cv_c_opt=],
[MACX:*:*],                 [ga_cv_c_opt=],
[NEC:*:*],                  [ga_cv_c_opt="-V -Cvsafe -O nomsg -pvctl,nomsg -Xa"],
