...
[AS_IF([test x$enable_opt = xno], [ga_cv_f77_opt="-O0"],
[AS_CASE([$ga_cv_target:$ax_cv_f77_compiler_vendor:$host_cpu],
[BGL:*:*],                  [ga_cv_f77_opt="-O0"],
[BGP:*:*],                  [ga_cv_f77_opt="-O3 -qstrict -qarch=450 -qtune=450"],
...
[LINUX64:fujitsu:ia64],     [ga_cv_f77_opt="-Kfast -X9 -Am"],
[LINUX64:fujitsu:x86_64],   [ga_cv_f77_opt="-Kfast -X9 -Am"],
[LINUX64:gnu:x86_64],       [ga_cv_f77_opt="-O0 -w"],
...
[LINUX:fujitsu:*],          [ga_cv_f77_opt="-Kfast -X9 -Am"],
...
[SOLARIS64:fujitsu:*],      [ga_cv_f77_opt="-Kfast -KV9FMADD"],
