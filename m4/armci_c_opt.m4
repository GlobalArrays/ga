...
[LINUX64:ibm:powerpc64:*],  [armci_cv_c_opt="-O3 -qlanglvl=extended -qinline=100 -qstrict -qarch=auto -qtune=auto"],
[LINUX64:ibm:ppc64:*],      [armci_cv_c_opt="-O3 -qlanglvl=extended -qinline=100 -qstrict -qarch=auto -qtune=auto"],
...
[LINUX:ibm:*:*],            [armci_cv_c_opt="-q32 -qlanglvl=extended"],
[LINUX:intel:*:*],          [armci_cv_c_opt="-O3 -prefetch"],
[MACX64:*:*:*],             [armci_cv_c_opt=],
[MACX:*:*:*],               [armci_cv_c_opt=],
[NEC:*:*:*],                [armci_cv_c_opt="-O nomsg -size_t64 -Nv -Xa"],
