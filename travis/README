Folder Contents
===============
This folder contains bash scripts used by the Travis CI build ([.travis.yml](../.travis.yml) in the root of the rpo).
...
As of October 30, 2018 this means that there are 42 builds run for each commit (2 OS x 2 compilers x 10 env settings + 2 xcode installs in Mac).
