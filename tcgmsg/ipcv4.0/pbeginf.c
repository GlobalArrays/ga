/* $Header: /tmp/hpctools/ga/tcgmsg/ipcv4.0/pbeginf.c,v 1.15 2005-09-21 20:22:01 manoj Exp $ */
...
#if defined(HPUX) || defined(SUNF77_2) || (defined(LINUX64)&&defined(__alpha__)) || defined(XLFLINUX) || defined(LINUX)
#define HAS_GETARG 1
#endif
#ifndef HAS_GETARG
void PBEGINF_()
