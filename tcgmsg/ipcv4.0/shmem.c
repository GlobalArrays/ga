/* $Header: /tmp/hpctools/ga/tcgmsg/ipcv4.0/shmem.c,v 1.10 1997-02-18 00:30:39 d3h325 Exp $ */
...
#if !defined(SGI) && !defined(KSR) && !defined(DECOSF) && !defined(HPUX) && !defined(AIX) && !defined(SOLARIS)
extern char *shmat();
#endif
