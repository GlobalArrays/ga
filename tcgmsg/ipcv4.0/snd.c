/* $Header: /tmp/hpctools/ga/tcgmsg/ipcv4.0/snd.c,v 1.13 2000-05-11 21:48:41 d3h325 Exp $ */
...
#include "sema.h"
#include "shmem.h"
#if defined(ALLIANT) || defined(SGI) || defined(SGITFP) || (defined(HPUX)&& !defined(HPUX64))
