/* $Header: /tmp/hpctools/ga/tcgmsg/ipcv5.0/pbeginf.c,v 1.2 2003-12-13 01:08:37 d3h325 Exp $ */
...
#if defined(HPUX) || defined(SUNF77_2) ||defined(PARAGON) ||defined(FUJITSU) || defined(WIN32) || defined (XLFMAC)
#define HAS_GETARG 1
#endif
