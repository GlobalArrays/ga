/* $Header: /tmp/hpctools/ga/tcgmsg/ipcv5.0/pbeginf.c,v 1.1 1999-09-01 20:22:22 d3h325 Exp $ */
...
#if defined(HPUX) || defined(SUNF77_2) ||defined(PARAGON) ||defined(FUJITSU) || defined(WIN32)
#define HAS_GETARG 1
#endif
