...
extern void wnga_free(void* ptr);
...
extern int wnga_initialize_comm(MPI_Comm comm);
...
extern void* wnga_malloc(Integer nelem, int type, char *name);
...
extern logical wnga_uses_irreg_proc_grid(Integer g_a);
extern void wnga_get_map_info(Integer g_a, Integer *num_blocks, Integer **map);
...
extern DoublePrecision wnga_rand(Integer idum);
...
extern Integer wnga_sprs_array_create(Integer idim, Integer jdim, Integer type, Integer trans);
extern Integer wnga_sprs_array_create_from_dense(Integer g_a, Integer idxsize, Integer flag);
extern Integer wnga_sprs_array_create_from_sparse(Integer s_a, Integer flag);
extern void wnga_sprs_array_add_element(Integer s_a, Integer idx, Integer jdx, void *val);
extern logical wnga_sprs_array_assemble(Integer s_a);
extern void wnga_sprs_array_row_distribution(Integer s_a, Integer iproc, Integer *lo, Integer *hi);
extern void wnga_sprs_array_column_distribution(Integer s_a, Integer iproc, Integer *lo, Integer *hi);
extern void wnga_sprs_array_access_col_block(Integer s_a, Integer icol, void *idx, void *jdx, void *val);
extern int wnga_sprs_array_access_col_block_idx(Integer s_a, Integer icol, AccessIndex *idx, AccessIndex *jdx, AccessIndex *vdx);
extern void wnga_sprs_array_col_block_list(Integer s_a, Integer **idx, Integer *n);
extern Integer wnga_sprs_array_duplicate(Integer s_a);
extern Integer wnga_sprs_array_matmat_multiply(Integer s_a, Integer s_b);
extern Integer wnga_sprs_array_sprsdns_multiply(Integer s_a, Integer g_b, Integer trans);
extern Integer wnga_sprs_array_dnssprs_multiply(Integer g_a, Integer s_b, Integer trans);
extern Integer wnga_sprs_array_count_sketch(Integer s_a, Integer size_k,
    Integer *g_k, Integer *g_w, Integer trans);
extern void wnga_sprs_array_matvec_multiply(Integer s_a, Integer g_a, Integer g_v);
extern logical wnga_sprs_array_destroy(Integer s_a);
extern void wnga_sprs_array_export(Integer s_a, const char* file);
extern void wnga_sprs_array_get_diag(Integer s_a, Integer *g_d);
extern void wnga_sprs_array_diag_right_multiply(Integer s_a, Integer g_d);
extern void wnga_sprs_array_diag_left_multiply(Integer s_a, Integer g_d);
extern void wnga_sprs_array_scale(Integer s_a, void *scale);
extern void wnga_sprs_array_shift_diag(Integer s_a, void *shift);
extern logical wnga_sprs_array_get_block(Integer s_a, Integer irow, Integer icol,
    void **idx, void **jdx, void **data, Integer *ilo, Integer *ihi,
    Integer *jlo, Integer *jhi);
extern Integer wnga_sprs_array_get_column(Integer g_v, Integer icol);
#endif /* WAPI_H_ */
