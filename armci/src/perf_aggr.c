...
void test_aggregate() {
	...
	for(j=start; j<end; j++) {  
      ...
      printf("%d: Aggregate Put time  = %.2e\n\n", me, MP_TIMER()-start_time);
	...
	for(j=start; j<end; j++) {  
      ...
      printf("%d: Aggregate Get time  = %.2e\n", me, MP_TIMER()-start_time);
    }
