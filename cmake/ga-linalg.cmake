...
function(check_ga_blas_options)
  ...
  if(NOT (_lap_set OR _lbp_set OR _llp_set OR _lsp_set) )
    message(FATAL_ERROR "GA_ENABLE_BLAS=ON but the options \
...
if (GA_ENABLE_BLAS)
    ...
    if(GA_ENABLE_SCALAPACK)
      ...
      if (ScaLAPACK_FOUND)
        ...
        message(FATAL_ERROR "GA_ENABLE_SCALAPACK=ON, but a ScaLAPACK library was not found")
      endif()
    endif()
    ...
    if (LAPACK_FOUND)
      ...
      message(FATAL_ERROR "GA_ENABLE_BLAS=ON, but a LAPACK library was not found")
    endif()
    ...
    if (BLAS_FOUND)
      ...
      message(FATAL_ERROR "GA_ENABLE_BLAS=ON, but a BLAS library was not found")
    endif()
