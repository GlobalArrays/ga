/* $Header: /tmp/hpctools/ga/tcgmsg-mpi/pbeginf.c,v 1.5 2000-05-09 17:50:36 d3h325 Exp $ */
...
#if defined(HPUX) || defined(SUN) ||defined(PARAGON) ||defined(FUJITSU) || defined(WIN32)
#define HAS_GETARG 1
#endif
