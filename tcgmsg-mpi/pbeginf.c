/* $Header: /tmp/hpctools/ga/tcgmsg-mpi/pbeginf.c,v 1.6 2000-05-09 20:07:01 d3h325 Exp $ */
...
#if defined(HPUX) || defined(SUN) || defined(SOLARIS) ||defined(PARAGON) ||defined(FUJITSU) || defined(WIN32)
#define HAS_GETARG 1
#endif
