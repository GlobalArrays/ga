/* p_cmx header file */
#ifndef _CMX_COMMON_ALLOC_H
#define _CMX_COMMON_ALLOC_H
 ...
 * @return CMX_SUCCESS on success
 */
int nbput(void *src, void *dst, int64_t bytes, int proc,
    cmx_request* req);
...
int nbputs(void *src, int64_t *src_stride, void *dst, int64_t *dst_stride,
        int64_t *count, int stride_levels, int proc, cmx_request* req);
 ...
 * @return CMX_SUCCESS on success
 */
int nbputv(cmx_giov_t *darr, int64_t len, int proc, cmx_request* req);
 ...
 * @return CMX_SUCCESS on success
 */
int acc(int op, void *scale, void *src, void *dst, int64_t bytes,
    int proc);
 ...
 * @return CMX_SUCCESS on success
 */
int nbaccv(int op, void *scale, cmx_giov_t *darr, int64_t len,
 ...
 * Strided Get.
 *
 * @param[in] src_pointer pointer to 1st segment at source 
 * @param[in] src_stride [stride_levels] array of strides at source
 * @param[in] dst pointer to 1st segment at destination
 * @param[in] dst_stride [stride_levels] array of strides at destination
 * @param[in] count number of units at each stride level count[0]=bytes
 ...
 * @return CMX_SUCCESS on success
 */
int nbget(void *src, void *dst, int64_t bytes, int proc, cmx_request *req);
 ...
 * @return CMX_SUCCESS on success
 */
int nbgetv(cmx_giov_t *darr, int64_t len, int proc, cmx_request *req);
